...
from cdjdlibrary.settings import ALLOWED_SIGNUP_DOMAINS
...
class SingUpForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        exclude = ['last_login', 'date_joined ', 'email', 'password', 'confirm_password',]
...
class LoginForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        exclude = ['last_login', 'date_joined','username', 'password']
